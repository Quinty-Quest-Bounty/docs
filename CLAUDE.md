...
- Base URL updated from api.quinty.io to be-quinty.fly.dev across all pages
- PATCH /bounties/drafts/:id endpoint documented (draft editing by owner)
- Draft flow updated: cover image required, edit step, on-chain tx before DB update
- Robot badge documentation (agentName in IPFS metadata)
